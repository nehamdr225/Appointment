...
class STheme with ChangeNotifier {
  ThemeData serviceDarkTheme = ThemeData(
    ...
    textTheme: TextTheme( 
        headline: TextStyle(fontSize: 24.0, color: textDarkMode, fontWeight: FontWeight.w500),
  ...
  ThemeData serviceLightTheme = ThemeData(
    ...
    textSelectionColor: Colors.black38,
    textTheme: TextTheme( 
        headline: TextStyle(fontSize: 24.0, color: textLightMode, fontWeight: FontWeight.w500),
